  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-center items-center text-white p-4 text-center">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-light mb-2 animate-fade-in-down header-content mt-20">
          Our Wedding Invitation
        </h1>
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-none animate-scale-in header-content">
          Debby & Ihsan
        </h1>
